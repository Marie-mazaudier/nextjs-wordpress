...
export default async function validateCode(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/wp-json/bdpwr/v1/validate-code`, {
            email: email,
