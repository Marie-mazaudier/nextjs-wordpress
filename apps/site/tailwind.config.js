...
module.exports = {
  content: [
    ...
    "./src/**/*.{js,ts,jsx,tsx}",
    "./pages/**/*.{js,ts,jsx,tsx}",
    "../../packages/ecommerce-ui/src/**/*.{js,ts,jsx,tsx}",
    "node_modules/@jstemplate/ecommerce-ui/src/**/*.{js,ts,jsx,tsx}",
    "node_modules/@jstemplate/checkout-flow/src/**/*.{js,ts,jsx,tsx}",
  ],
  theme: {
    screens: {
      sm: "576px",
    ...
    extend: {
      colors: {
        themePrincipal: "#CEC2AA",
        themeBlack: "#000",
        themePrimary50: "#FFF0EE",
        themePrimary100: "#FFE0DC",
        themePrimary200: "#FFD1CB",
        themePrimary300: "#ffab91",
        themePrimary400: "#ff8964",
        themePrimary500: "#ff6838",
        themePrimary600: "#ff5722",
        themePrimary700: "#e64e1f",
        themePrimary800: "#cc461b",
        themePrimary900: "#b33d18",
